      ...
      <div class="py-8">
        ...
        <div class="flex flex-col md:flex-row items-center justify-center md:justify-between mb-4">
          <div class="shrink-0 mr-4">
            <!-- Logo -->
            <router-link class="inline-flex group mb-8 md:mb-0" to="/" aria-label="Cruip">
          ...
          <div class="text-sm font-medium md:order-1 mb-2 md:mb-0">
            <ul class="inline-flex flex-wrap text-sm space-x-6">
              ...
              <li>
                <a class="text-slate-500 underline hover:no-underline" href="#0">FAQs</a>
              </li>
              <li>
                <a class="text-slate-500 underline hover:no-underline" href="#0">Get In Touch</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div class="text-center md:flex md:items-center md:justify-between">
          ...
          <ul class="inline-flex mb-4 md:order-1 md:ml-4 md:mb-0 space-x-2">
            <li>
              <a class="flex justify-center items-center text-indigo-500 hover:text-indigo-400 transition duration-150 ease-in-out" href="#0" aria-label="Twitter">
            ...
            <li>
              <a class="flex justify-center items-center text-indigo-500 hover:text-indigo-400 transition duration-150 ease-in-out" href="#0" aria-label="YouTube">
                <svg class="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
            ...
            <li>
              <a class="flex justify-center items-center text-indigo-500 hover:text-indigo-400 transition duration-150 ease-in-out" href="#0" aria-label="Github">
                <svg class="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
            ...
            <li>
              <a class="flex justify-center items-center text-indigo-500 hover:text-indigo-400 transition duration-150 ease-in-out" href="#0" aria-label="Telegram">
                <svg class="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
          ...
          <!-- Copyright -->
          <div class="text-sm text-slate-600">Copyright &copy; Cruip. All rights reserved.</div>
